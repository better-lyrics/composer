  ...
  <div className="space-y-5">
    ...
    <div>
      ...
      <ul className={`${PROSE} list-disc pl-4 space-y-1`}>
        ...
        <li>
          <strong>Rolling</strong> (<InlineKeyBadge keys={getEffectiveKeysArray("timeline.toggleRollingEdit")} />): the
        ...
        <li>
          <strong>Snap</strong> (<InlineKeyBadge keys={getEffectiveKeysArray("timeline.toggleSnap")} />): a magnet for
          word edges and the playhead. Hold {MOD_KEY} mid-drag to bypass.
        </li>
        <li>
          <strong>Import</strong> (<InlineKeyBadge keys={getEffectiveKeysArray("timeline.importLyrics")} />): imports
