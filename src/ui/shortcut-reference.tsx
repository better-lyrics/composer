...
const SHORTCUT_SECTIONS: ShortcutSectionProps[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ["PageUp"], description: "Page playhead back one screen", shortcutId: "timeline.pagePlayheadBack" },
      {
        keys: ["PageDown"],
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ["Alt", "ArrowLeft"], description: "Nudge selected words left", shortcutId: "timeline.nudgeLeft" },
      { keys: ["Alt", "ArrowRight"], description: "Nudge selected words right", shortcutId: "timeline.nudgeRight" },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      {
        keys: ["Alt", "ArrowLeft"],
        description: "Nudge selected words / instance earlier",
        shortcutId: "timeline.nudgeLeft",
      },
      {
        keys: ["Alt", "ArrowRight"],
        description: "Nudge selected words / instance later",
